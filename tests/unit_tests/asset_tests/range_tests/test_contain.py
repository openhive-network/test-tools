...
@pytest.mark.parametrize(
    ...
    [
        ...
        (tt.Asset.Hbd(1), tt.Asset.Hbd(1), tt.Asset.Hbd(3)),
        (tt.Asset.Hbd(3), tt.Asset.Hbd(1), tt.Asset.Hbd(3)),
    ],
)
...
@pytest.mark.parametrize("asset", [tt.Asset.Test(0.9), tt.Asset.Test(1.1)])
def test_the_percentage_range_of_the_given_asset(asset):
    assert asset in tt.Asset.Range(tt.Asset.Test(1), tolerance=10)


@pytest.mark.parametrize("asset", [tt.Asset.Test(0.899), tt.Asset.Test(1.101)])
