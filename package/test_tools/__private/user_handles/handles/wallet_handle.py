...
class WalletHandle(Handle):
    ...
    def in_single_transaction(self, *, broadcast: bool = None):
        ...
        return self._implementation.in_single_transaction(broadcast=broadcast)
    ...
    def run(self, *, timeout: float = Wallet.DEFAULT_RUN_TIMEOUT, preconfigure: bool = True):
        ...
        self._implementation.run(timeout=timeout, preconfigure=preconfigure)
    ...
    def restart(self, *, preconfigure: bool = True):
        ...
        self._implementation.restart(preconfigure=preconfigure)
    ...
    def transaction_serialization(self) -> Literal["legacy", "hf26"]:
        ...
        return self._implementation.transaction_serialization
    ...
    def create_accounts(
        ...
        return self._implementation.create_accounts(
    ...
    def list_accounts(self) -> List[str]:
        ...
        """
        return self._implementation.list_accounts()
