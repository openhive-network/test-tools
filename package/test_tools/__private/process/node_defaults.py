...
class NodeDefaults(PreconfiguredBaseModel):
    ...
    DEFAULT_LOG_APPENDER: ClassVar[list[str]] = ["""{"appender":"stderr","stream":"std_error","time_format":"iso_8601_microseconds"}""", """{"appender":"p2p","file":"logs/p2p/p2p.log","time_format":"iso_8601_milliseconds"}"""]
    ...
    DEFAULT_LOG_LOGGER: ClassVar[list[str]] = ["""{"name":"default","level":"info","appenders":["stderr"]}""", """{"name":"user","level":"debug","appenders":["stderr"]}""", """{"name":"p2p","level":"warn","appenders":["p2p"]}"""]
    ...
    DEFAULT_PLUGIN: ClassVar[list[str]] = ["witness", "account_by_key", "account_by_key_api", "state_snapshot"]
