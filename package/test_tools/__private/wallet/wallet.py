...
class Wallet(UserHandleImplementation, ScopedObject):
    ...
    def complex_transaction_sign(self, transaction: SimpleTransaction) -> SimpleTransaction:
        ...
        sign_keys, retrived_authorities = self.import_required_keys(transaction_bytes)
    ...
    def reduce_signatures(
        ...
        keys_to_sign_with: list[str] | list[Any],
    ...
    def import_required_keys(
    ...
    ) -> tuple[list[str] | list[Any], dict[bytes, wax.python_authorities]]:
        ...
        return list(set(keys_for_signing) & set(imported_keys_in_beekeeper)), retrived_authorities
