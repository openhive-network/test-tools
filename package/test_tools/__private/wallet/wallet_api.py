...
class Api:
    ...
    def get_collateralized_conversion_requests(
        ...
        """
        assert self.__wallet.connected_node is not None, "Node is neccessary to get_collateralized_conversion_requests"
    ...
    def list_proposals(
        ...
        return self.__wallet.connected_node.api.wallet_bridge.list_proposals(start, limit, order_by, order_type, status)
    ...
    def sign_transaction(
        ...
        tx = self.__wallet.complex_transaction_sign(tx)
