...
from test_tools.__private.utilities.create_accounts import (
    SimpleTransaction,
    WalletResponseBase,
    create_accounts,
    get_authority,
...
class Wallet(UserHandleImplementation, ScopedObject):
    ...
    class Api:
        ...
        def __init__(self, wallet: Wallet) -> None:
            ...
            self.__transaction_builder: Wallet.Api.TransactionBuilder | None = None
        ...
        def create_account(
            ...
            :return: Response object containing information about the transaction.
            """
            assert not self.is_locked(), "Wallet must be unlocked to create_account"
            assert self.__wallet.connected_node is not None, "Node is neccessary to create_account"
        ...
        def create_account_with_keys(
            ...
            :return: Response object containing information about the transaction.
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to create_account_with_keys"
        ...
        def create_funded_account_with_keys(
            ...
            """
            assert not self.is_locked(), "Wallet must be unlocked"
            assert self.__wallet.connected_node is not None, "Node is neccessary to create_funded_account_with_keys"
        ...
        def create_order(
            ...
            """
            assert not self.is_locked(), "Wallet must be unlocked"
            assert self.__wallet.connected_node is not None, "Node is neccessary to create_order"
        ...
        def find_proposals(
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to find_proposals"
        ...
        def find_rc_accounts(
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to find_rc_accounts"
        ...
        def find_recurrent_transfers(
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to find_recurrent_transfers"
        ...
        def get_account(
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to get_account"
        ...
        def get_account_history(
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to get_account_history"
        ...
        def get_accounts(
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to get_accounts"
        ...
        def get_active_witnesses(
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to get_active_witnesses"
        ...
        def get_block(
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to get_block"
        ...
        def get_collateralized_conversion_requests(
            ...
            """
            assert (
                self.__wallet.connected_node is not None
            ), "Node is neccessary to get_collateralized_conversion_requests"
        ...
        def get_conversion_requests(
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to get_conversion_requests"
        ...
        def get_encrypted_memo(
            ...
            return wax_helpy.encrypt_memo(
                ...
                content=memo,
                second_step_callback=proxy_encrypt_data,
            )
        ...
        def get_feed_history(self, only_result: bool | None = None) -> GetFeedHistory:  # noqa: ARG002
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to get_feed_history"
        ...
        def get_open_orders(
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to get_open_orders"
        ...
        def get_ops_in_block(
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to get_ops_in_block"
        ...
        def get_order_book(self, limit: int, only_result: bool | None = None) -> GetOrderBook:  # noqa: ARG002
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to get_order_book"
            max_limit = 1000
        ...
        def get_owner_history(
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to get_owner_history"
        ...
        def get_transaction(self, trx_id: str, only_result: bool | None = None) -> GetTransaction:  # noqa: ARG002
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to get_transaction"
        ...
        def get_withdraw_routes(
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to get_withdraw_routes"
        ...
        def get_witness(
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to get_witness"
        ...
        def list_accounts(
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to list_accounts"
        ...
        def list_my_accounts(self, only_result: bool | None = None) -> ListMyAccounts:  # noqa: ARG002
            ...
            assert self.__wallet.connected_node is not None, "Node is neccessary to list_my_accounts"
        ...
        def list_proposal_votes(
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to list_proposal_votes"
        ...
        def list_proposals(
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to list_proposals"
        ...
        def list_rc_accounts(
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to list_rc_accounts"
        ...
        def list_rc_direct_delegations(
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to list_rc_direct_delegations"
            start_len = 2
        ...
        def list_witnesses(
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to list_witnesses"
        ...
        def serialize_transaction(self, tx: Transaction, only_result: bool | None = None) -> Hex:  # noqa: ARG002
            ...
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to serialize_transaction"
            transaction_hex = self.__wallet.connected_node.api.database.get_transaction_hex(trx=tx)
        ...
        def sign_transaction(
            self, tx: SimpleTransaction, broadcast: bool = True, only_result: bool | None = None  # noqa: ARG002
        ) -> None | WalletResponseBase | WalletResponse:
            """
            ...
            :return: The response from the blockchain.
            """
            assert self.__wallet.connected_node is not None, "Node is neccessary to sign_transaction"
            tx = self.__wallet.sign_transaction(self.__wallet.connected_node, tx)
            return self.__wallet.broadcast_transaction(transaction=tx, blocking=True, broadcast=broadcast)
