...
def wait_for_event(event: 'Event',
    ...
    :param exception: Raised when deadline is reached. If None, raises default TimeoutError.
    """
    if exception is None:
        exception = TimeoutError('The event didn\'t occur within given time frame')
